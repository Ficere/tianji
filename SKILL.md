---
name: tianji
description: "天机 —— 综合命理测算技能（v7.0）。一站式完成八字五行、称骨、紫微斗数（14主星+四化+大限）、西洋星座（太阳/月亮/上升）、三才五格姓名测算及多场景合盘。v7.0新增三层叙事框架（内在内核/命运方向/外在表现）、场景化合盘（情侣/亲子/原生家庭/朋友圈/工作团队/合伙人/管理者决策）、个人深度分析路径、MBTI动态层处理。当用户提到命理测算、算命、八字、五行、称骨、紫微、星座、合盘、三才五格、姓名测算、姓名打分、名字吉凶、综合测算、一站式测算、天机、怎么和他沟通、如何安排工作、亲子养育建议时使用此技能。" 
metadata:
  author: computer
  version: '7.0.0'
  language: zh-CN
...
- 差异≤3满分，4-5良好，6-8一般，>8偏差大；五行俱全额外+5分
...
**星座相位（15分）—— 双人场景或关键对关系**
- 0°/60°/120° = +5分 | 30° = +4分 | 180° = +3分 | 90° = +2分 | 150° = +1分
...
| 命运契合度 | 你们的人生主题是否在同一时区？ | 大限重叠度 + 称骨基准对比 + 生肖关系 | 35分 |
| 外在摩擦点 | 相处界面有哪些结构性卡点？ | 太阳星座角度 + 五行显性差异 + MBTI当前类型差异 | 25分 |
...
| 八字日主 | 内在内核 | 终身不变 |
| 月亮星座 | 内在内核 | 终身不变 |
| MBTI底层功能栈（主导+辅助，如Ni-Fe） | 内在内核 | 极稳定，不随经历改变 |
| 紫微当前大限 | 命运方向 | 每10年一换 |
| 称骨总重 | 命运方向 | 资源禀赋基准线 |
| 命宫/流年化忌 | 命运方向 | 反复出现的人生功课 |
| 生肖关系（合盘时） | 命运方向 | 结构性张力 |
| MBTI当前测试结果（J/P、E/I等） | 外在表现 | 随经历和阶段变化 |
| 太阳星座 | 外在表现 | 较稳定但受环境影响 |
| 上升星座 | 外在表现 | 社交界面/第一印象 |
| 八字年柱月柱 | 外在表现 | 成长塑造/起点环境 |
| 三才五格 | 外在表现 | 名字带来的气场 |
...
```
第一段（内核）：
整合日主 + 月亮星座 + 命宫主星 + MBTI底层功能（如提供）
→ 2-3句话：这个人骨子里是什么样的人？核心驱动力是什么？内在最深的需求是什么？
→ 若三个维度指向一致 → 强化结论（高度自洽人格）
...
第三段（外在）：
整合上升星座 + 太阳星座 + 当前MBTI（如提供）
→ 1句话：初次见面时别人眼中的ta是谁？和真实内核的落差有多大？
→ 落差大的人往往有很强的「被误解感」
...
**MBTI特殊处理规则：**
- 底层功能栈（如INFJ的Ni-Fe）归入内核层，与命宫主星、日主互相印证
- 当前测试结果归入外在层，标注「当前状态，受近期经历影响」
- 若命盘内核信号与当前MBTI不一致 → 重点分析：此人目前处于「压力变体」还是「成长转型期」
- 绝不将MBTI当静态标签，始终说明其动态性
